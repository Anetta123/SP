...
int tCG::p37(){ //    BOOL -> CPRED
	return 0;}
int tCG::p38(){ //   CPRED -> ( $idq )
S1->obj += decor(S2->name) + "()";
	return 0;}
int tCG::p39(){ //   CPRED -> ( $idq PDARGS )
S1->obj += decor(S2->name) + "(" + S3->obj + ")";
	return 0;}
int tCG::p40(){ //  PDARGS -> ARG
	return 0;}
int tCG::p41(){ //  PDARGS -> ARG PDARGS
S1->obj += ",  " + S2->obj;
	return 0;}
int tCG::p42(){ //     ARG -> E
	return 0;}
...
if (S1->count) {
    ...
    ++S1->count;
	return 0;}
int tCG::p74(){ //     VAR -> ( define $id VARINI )
